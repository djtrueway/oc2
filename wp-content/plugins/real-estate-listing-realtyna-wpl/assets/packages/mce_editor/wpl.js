    ...
    tinymce.create('tinymce.plugins.wplbuttons', {
        ...
        init : function(ed, url) {
            ...
            ed.addCommand('wplshortcode', function() {
                var wpl_base_url = ajaxurl.replace('admin-ajax.php', '');
                ed.windowManager.open({
                    file : wpl_base_url+(wpl_base_url.indexOf('?') !== -1 ? '&' : '?')+'wpl_format=c:functions:ajax:1&wpl_function=shortcode_wizard&lang=all',
